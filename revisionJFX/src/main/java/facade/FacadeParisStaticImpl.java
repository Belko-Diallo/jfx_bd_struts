...
public class FacadeParisStaticImpl implements FacadeParis {
    ...
    public FacadeParisStaticImpl() {
        ...
        Utilisateur u1 = Utilisateur.create("b", "b");
        Utilisateur u2 = Utilisateur.createAdmin("admin", "admin");
        ...
        long m2 = 0;
        try {
            m1 = ajouterMatch("admin", "foot", "Allemagne", "France", LocalDateTime.now().plusMinutes(5));
            ajouterMatch("admin", "rugby", "France", "Australie", LocalDateTime.now().minusDays(7));
            m2 = ajouterMatch("admin", "foot", "France", "Australie", LocalDateTime.now().plusMonths(5));
            ajouterMatch("admin", "foot", "France", "Pérou", LocalDateTime.now().plusMonths(4));
            ajouterMatch("admin", "foot", "Danemark", "France", LocalDateTime.now().plusMonths(9));
